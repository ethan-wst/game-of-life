...
import random
import time
game_of_life =  __import__('game-of-life')
...
if __name__ == "__main__":
    ...
    actual_next_state1 = game_of_life.next_board_state(init_state1, 3, 3 )
    ...
    actual_next_state2 = game_of_life.next_board_state(init_state2, 3, 3)
